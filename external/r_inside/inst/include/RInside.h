...
class RInside
{
    private:
        ...
        void initialize( const int argc, const char *const argv[], const bool loadRcpp, const bool verbose,
    ...
    public:
        class Proxy
        {
            public:
                ...
                template <typename T> operator T() { return ::Rcpp::as<T>( x ); }
        ...
        template <typename T> void assign( const T &object, const std::string &nam )
        {
